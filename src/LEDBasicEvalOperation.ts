import { COLOUR_ORDER, IConfig, IOperationList, lib_map, IMatchResult, IError, IJumpTable, IEvalOperation } from './Common';

var JumpTable: IJumpTable = {};
var lineNumber = 0;
var errors: IError[] = [];

export var operation: IEvalOperation = {
    ...
    string: function (qln1, b, qln2) {
        var strArray = b.sourceString.split('').map((c: string) => c.charCodeAt(0));
